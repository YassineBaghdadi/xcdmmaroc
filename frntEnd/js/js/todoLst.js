...
var openTreatWndw = (i) =>{
  ...
  fetch("/TO-DO-Liste/getTreatWindow", {
    method: "POST",
    headers: {
...
var getTasks = async() =>{
  await fetch("/TO-DO-Liste/getTasks")
    .then((response) => {
      if (response.ok) {
...
var treatTheDchrg = (t, tt) =>{ 
  if ($('#DchrgTrComment').val()) {
    ...
    fetch("/TO-DO-Liste/treatTheDchrg", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  var RHtreatRCPreq = (t, tt) =>{ 
    ...
    fetch("/TO-DO-Liste/RHtreatRCPreq", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  var getTskCntrTbl = (i) => {
    fetch("/TO-DO-Liste/getTaskCntrbs", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
$('#saveTaskAssign').click(()=>{
  fetch("/TO-DO-Liste/assignUsersToTask", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
  ...
  // console.log($("#LSTUser").val());
    ...
    $.get("/TO-DO-Liste/getAllUsers", function (data) {
      $("#LSTUser").html(data);
      // console.log(data);
    }).fail(function () {
